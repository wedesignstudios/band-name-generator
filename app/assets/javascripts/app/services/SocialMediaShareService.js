function SocialMediaShareService($window) {
  ...
  this.fbSDK = $window.fbAsyncInit = function() {
    ...
    this.twtrTweet = (name) => {
      return `https:\/\/twitter.com/intent/tweet?text=I+just+used+Banderoo+to+name+my+band+%22${name}%22&hashtags=bands,bandname,banderoo&url=https%3A%2F%2Fbanderoo.com%2F`;
    }
